// Fake credentials for SafeDigital practice environment
...
export const FAKE_CREDENTIALS: Record<string, FakeUser> = {
  ...
  admin: {
    username: "admin.safedigital",
    password: "Admin2026!",
    fullName: "SafeDigital Administrator",
    nric: "S9876543Z",
    phone: "6123 4567",
    email: "admin@safedigital.org",
    dob: "01/01/1990",
    address: "SafeDigital Centre, Singapore",
    role: "admin",
  },
};
